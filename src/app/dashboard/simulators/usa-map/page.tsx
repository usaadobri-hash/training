...
export default function USAMapSimulator() {
  ...
  const handleMapClick = (stateAbbr: string) => {
    const clickedAbbr = stateAbbr;
  ...
  // Build the customStates object for @mirawision/usa-map-react
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const customStates: any = {};
  if (highlightedState) {
    customStates[highlightedState] = {
